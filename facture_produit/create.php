...
<div class="alert alert-danger">
    <?=$message?>
                ...
                <form action="create.php?<?php if(isset($_GET['numero'])) echo 'numero='.$_GET['numero']?>" method="post">
                    Facture : <select type="text" name="numero" class="form-control" onchange="window.location='http://localhost/facturation/facture_produit/create.php?numero='+this.value">
